text_file2=fullfile('/projects','niblab','data','HCP','graphs','thresh','day2','clustering_coef.txt');
disp(text_file)
open_file=fopen(text_file2,'a');
...
for x=linspace(1,len,len)
	...
	fprintf(open_file, fmt_long, group, filename, C);
end
fclose(open_file)
