text_file=fullfile('/projects','niblab','data','HCP','graphs','run02','day2','thresh','nodal_degree.txt');
disp(text_file)
...
file_list=glob('/projects/niblab/data/HCP/graphs/run02/day2/thresh/*/binary/corr_*.mat')
...
for x=linspace(1,len,len)%loop through the number of files possible
	...
	NodDeg=degrees_und(data)
	fprintf(open_file, fmt, group, filename, NodDeg);%this is appending the output to the correct file
end
fclose(open_file)
